...
public class DataPerpustakaan {
  public static void main(String[] args) {
    ...
    dataMahasiswa.add(new Mahasiswa("1", "M.Haikal irhamna"));
    dataMahasiswa.add(new Mahasiswa("2", "Ririn apriliani"));
    dataMahasiswa.add(new Mahasiswa("3", "Erin"));

    ArrayList <Buku> dataBuku = new ArrayList<>(); 

    dataBuku.add(new Buku("1", "Software engineering"));
    dataBuku.add(new Buku("2", "web development"));
    dataBuku.add(new Buku("3", "Programmer pemula"));
